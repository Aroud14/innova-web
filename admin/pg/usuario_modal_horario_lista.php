                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                                <a type="button" href="javascript:void(0)" onclick="modal_usuario_horario_registro(<?php echo $id; ?>, <?php echo $resultado->id_usuario_horario; ?>)" class="btn btn-inline btn-sm btn-info" data-bs-toggle="tooltip" data-bs-placement="top" title="Horarios"><i class="fa fa-edit"></i></a>
                                        <?php
                                            }
                                        ?>
                                        ...
                                        ?>
                                                <a type="button" onclick="eliminar(5,<?php echo $resultado->id_usuario_horario ?>);" class="btn btn-inline btn-sm btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Eliminar"><i class="fa fa-trash"></i></a> 
                                        <?php
                                            }
                                        ?>
