...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Catalogo de Etiquetas blog</h4>
    </div>
</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="n" name="nombre" placeholder="Nombre de la etiqueta">
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" style="margin-top:33px;">
                                    ...
                                    <input type="button" class="btn btn-success btn-sm" value=" Buscar " onclick="lista_etiquetablog()" />
