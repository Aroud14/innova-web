...
$total = $conexion->consultaregistro($querys->getconteoetiquetablog($nombre));
$resul_lista = $conexion->obtenerlista($querys->getlistetiquetablog($nombre, $inicio, $limite));
?>
<div class="white-box">
            ...
            <tr>
                ...
                <td>
                    <?php if($datos_sis['editar'] == 1) { ?>
                        <a type="button" href="javascript:void(0)" onclick="registro_etiquetablog(<?php echo $value->id_etiqueta_blog; ?>)" class="btn btn-inline btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><i class="fa fa-edit"></i></a>
                    <?php } ?>
                    <?php if($datos_sis['eliminar'] == 1) { ?>
                        <a type="button" class="btn btn-inline btn-sm btn-danger" onclick="eliminar(25,<?php echo $value->id_etiqueta_blog ?>);" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar"><i class="fa fa-trash"></i></a>
                    <?php } ?>
                </td>
            </tr>
        <?php } ?>
