...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <a style="float: right;" class="popup-with-form btn btn-success" href="javascript:void(0);" onclick="registro_blog();" id="boton-registro"> <i class="fa fa-plus"></i> Registrar Blog</a>
        <a style="float: right;" class="popup-with-form btn btn-success" href="javascript:void(0);" onclick="lista_blog();" id="boton-regresar"><-- Regresar</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group" style="margin-top:33px;">
                            ...
                            <input type="button" class="btn btn-success btn-sm" value=" Buscar " onclick="lista_blog()" />
