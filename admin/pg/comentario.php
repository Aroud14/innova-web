...
<div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Comentarios de blog</h4>
    </div>
</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label semibold" for="n">Autor</label>
                                    <input type="text" class="form-control" id="n" name="nombre" placeholder="Nombre del autor">
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group" style="margin-top:33px;">
                                    ...
                                    <input type="button" class="btn btn-success btn-sm" value=" Buscar " onclick="lista_comentario()" />
