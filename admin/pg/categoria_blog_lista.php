...
require "../php/inicializandoDatosExterno.php"; 
    ...
    $total = $conexion->consultaregistro($querys->getconteocategoriablog($nombre));
    $resul_lista = $conexion->obtenerlista($querys->getlistcategoriablog($nombre, $inicio, $limite));
?>
<div class="white-box">
            ...
            <tr>
                ...
                <td>
                    <?php if($datos_sis['editar'] == 1) { ?>
                        <a type="button" href="javascript:void(0)" onclick="registro_categoriablog(<?php echo $value->id_categoria_blog; ?>)" class="btn btn-inline btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><i class="fa fa-edit"></i></a>
                    <?php } ?>
                    <?php if($datos_sis['eliminar'] == 1) { ?>
                        <a type="button" class="btn btn-inline btn-sm btn-danger" onclick="eliminar(24,<?php echo $value->id_categoria_blog ?>);" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar"><i class="fa fa-trash"></i></a>
                    <?php } ?>
                </td>
            </tr>
        <?php } ?>
