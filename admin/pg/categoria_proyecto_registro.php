...
if($_POST['id']>0){
    ...
    $sql = $querys->getcategoriaproyecto($id);
...
<div class="white-box">
    ...
    <form method="post" action="php/subir.php" id="enviar_formulario"  enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-md-12">
                <input type="hidden" name="opcion" value="<?php if(isset($id)) echo '119'; else echo '118'; ?>" />
                <input type="hidden" name="id" id="id" value="<?php if(isset($id)) echo $id ?>">
                <button class="btn btn-primary" type="submit" id="btn_guardar"  >Guardar</button>
                <button class="btn btn-danger" type="button" onclick="registro_categoria_proyecto()">Cancelar</button>
            </div>
        </div>
    </form>
</div>