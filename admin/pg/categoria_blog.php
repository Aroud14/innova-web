...
<!--NAVEGACION MIGAJAS DE PAN-->
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Catalogo de Categorias blog</h4>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group" style="margin-top:33px;">
                                                    ...
                                                    <input type="button" class="btn btn-success btn-sm" value=" Buscar " onclick="lista_categoriablog()" />
